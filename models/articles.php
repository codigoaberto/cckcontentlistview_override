...
class ContentModelArticles extends JModelList
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$contenttypeId = $this->getUserStateFromRequest($this->context . '.filter.type_cck', 'filter_type_cck', '');
		$this->setState('filter.type_cck', $contenttypeId);
	...
	protected function getListQuery()
	{
		...
		// Join over seblod cck content types.		
		...
		$contenttypeId = $this->getState('filter.type_cck');

		if ($contenttypeId)
		{
			$query->where('k.cck LIKE ' . (string)$contenttypeId);
		}
